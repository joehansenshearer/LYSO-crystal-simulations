...
private:
  const B4DetectorConstruction* cDetConstruction;
  B4aEventAction*  cEventAction;
    const B4DetectorConstruction* tDetConstruction;
    B4aEventAction*  tEventAction;
    const B4DetectorConstruction* bDetConstruction;
    B4aEventAction*  bEventAction;
    const B4DetectorConstruction* lDetConstruction;
    B4aEventAction*  lEventAction;
    const B4DetectorConstruction* rDetConstruction;
    B4aEventAction*  rEventAction;
};
